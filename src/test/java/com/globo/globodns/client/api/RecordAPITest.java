...
public class RecordAPITest {
    ...
    public void testListByQuery() throws GloboDnsException {
        ...
        this.rp.registerFakeRequest(
                HttpMethod.GET,
                "/domains/" + domainId + "/records.json?query=" + recordContent,
    ...
    @Test
    public void testCreateRecordFullIpv6() throws GloboDnsException {
        String newRecordName = "testipv6";
        String newRecordContent = "FE80:0000:0000:0000:0202:B3FF:FE1E:8329";
        String newRecordType = "AAAA";
        this.rp.registerFakeRequest(
                HttpMethod.POST,
                "/domains/" + domainId + "/records.json",
                "{\"record\":{\"content\":\"FE80:0000:0000:0000:0202:B3FF:FE1E:8329\",\"created_at\":\"2014-03-28T19:38:03Z\",\"domain_id\":2000,\"id\":10,\"name\":\"testipv6\",\"prio\":null,\"ttl\":null,\"updated_at\":\"2014-03-28T19:38:03Z\"}}");
    ...
    @Test
    public void testCreateRecordCollapsedIpv6() throws GloboDnsException {
        String newRecordName = "testipv6";
        String newRecordContent = "FE80::0202:B3FF:FE1E:8329";
        String newRecordType = "AAAA";
        this.rp.registerFakeRequest(
                HttpMethod.POST,
                "/domains/" + domainId + "/records.json",
                "{\"record\":{\"content\":\"FE80::0202:B3FF:FE1E:8329\",\"created_at\":\"2014-03-28T19:38:03Z\",\"domain_id\":2000,\"id\":10,\"name\":\"testipv6\",\"prio\":null,\"ttl\":null,\"updated_at\":\"2014-03-28T19:38:03Z\"}}");
